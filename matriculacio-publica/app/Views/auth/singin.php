    ...
    <div class="singIn-container">
        ...
        <form>
            <div class="mb-3">
                ...
                <input type="text" class="form-control DNIuser" id="dniInput" placeholder="Exemple: 12345678A"
                    maxlength="9" required>
                <div class="form-text">Introdueix el teu DNI o NIE</div>
            </div>
            <div class="mb-3">
                <label for="mailInput" class="form-label">Correu electrònic</label>
                <input type="email" class="form-control mailuser" id="mailInput" placeholder="exemple@correu.com"
                    required>
