...
<head>
    ...
    <style>
        ...
        .capcalera {
            color: #6D78D0;
            border-bottom: 2px solid #6D78D0;
            padding-bottom: 10px;
            margin-bottom: 20px;
        }
...
<body>
    <div class="caixa">
        ...
        <p>Pots respondre a aquest correu o trucar a la secretaria del centre per a qualsevol dubte: <strong>973 288
                180</strong> o <strong>973 980 350</strong>.</p>

        <hr style="margin-top: 30px; border: 0; border-top: 1px solid #ccc;">
        <p style="font-size: 0.85em; color: #777;">Aquest és un correu generat automàticament des del sistema de
            matriculacions.</p>
    </div>
</body>
